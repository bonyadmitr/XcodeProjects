...
import UIKit
    ...
    /// https://github.com/nrbrook/NBUIKitMainThreadGuard/blob/master/NBUIKitMainThreadGuard.swift
    ...
    extension UIView {
        ...
        private func nb_mainThreadCheck() {
            ...
            print(DispatchQueue.currentLabel ?? "nil")
