...
@implementation ZZSetupController
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField{
    ...
    //getting next textField
    //+1 becouse last textField index = array.count - 1
    NSInteger index = [self.textFieldCollection indexOfObject:textField] + 1;
    
    if (index < self.textFieldCollection.count) {
        // Found next responder, so set it.
        [self.textFieldCollection[index] becomeFirstResponder];
    } else {
